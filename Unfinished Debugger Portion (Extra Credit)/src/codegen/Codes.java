...
public class Codes {
	...
	public static enum ByteCodes {
		HALT,POP,FALSEBRANCH,GOTO,STORE,LOAD,LIT,ARGS,CALL,RETURN,BOP,READ,WRITE,LABEL,FUNCTION,
		LINE,FORMAL
	};
...
*/
    ...
    frameChange.put(ByteCodes.LINE,0);             // source line label
    frameChange.put(ByteCodes.FUNCTION,0);         // function parameters for debugger
    frameChange.put(ByteCodes.FORMAL,0);          // argument parameters for debugger
    }
