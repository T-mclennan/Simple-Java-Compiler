...
*/           
    ...
    void genIntrinsicCodes() {
        ...
        storeop(new Code(Codes.ByteCodes.LINE));
        storeop(new FunctionOpcode(Codes.ByteCodes.FUNCTION, readLabel, -1, -1));
        ...
        String formal = ((IdTree)(writeTree.getKid(3).getKid(1).getKid(2))).
                                 getSymbol().toString();
        storeop(new Code(Codes.ByteCodes.LINE));
        storeop(new FunctionOpcode(Codes.ByteCodes.FUNCTION, writeLabel, -1, -1));
...
*/
    public Object visitFunctionDeclTree(AST t) {
        ...
        if (t.getLine() != lineNo) {
        	lineNo = t.getLine();
            storeop(new NumOpcode(Codes.ByteCodes.LINE,lineNo));
        }
